...
public class NodeTest {
	...
	public static void main(String[] args){
            //Step 1: Create a binary tree (NOT a BST) using the following data: 55, 23, 11, 75, 50, 15, 25, 60, 63, 69. 
                BinaryTree tree = balancedBinaryTreeV2();
    ...
    public static BinaryTree balancedBinaryTreeRemade(){
        BinaryTree tree = new BinaryTree();
            //55, 23, 11, 75, 50, 15, 25, 60, 63, 69. 
...
//                     \       \      /
//                     15      25    63
//In Order:     11 15 23 60 25 55 50 75 63 69
//Pre Order:    55 23 11 15 60 25 75 50 69 63
//Post Order:   15 11 25 60 23 50 62 69 75 55 
//In Order:     55 23 75 11 60 50 69 15 25 63
...
//In Level Order:  55 23 63 11 25 69 5 15 10 20 
    ...
    public static BinaryTree balancedBinaryTreeV2(){
        ...
        //tree.root = tree.balancedBinaryTreeHelper(new int[]{55, 23, 11, 75, 50, 15, 25, 60, 63, 69}, 0, 9);

        return tree;
    }
    
    public BinaryTree fullBinaryTree(){
        BinaryTree tree = new BinaryTree();
            tree.root = new Node(55);
